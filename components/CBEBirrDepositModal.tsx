...
interface CBEBirrDepositModalProps {
    onClose: () => void;
}

const CBEBirrDepositModal: React.FC<CBEBirrDepositModalProps> = ({ onClose }) => {
    return (
        <div className="fixed inset-0 bg-black bg-opacity-75 flex justify-center items-center z-50">
            <div className="bg-slate-800 rounded-lg shadow-2xl p-8 w-full max-w-lg text-white border border-slate-600">
                <div className="flex justify-between items-center mb-6">
                    <h2 className="text-2xl font-bold">CBE Birr Transfer Deposit</h2>
                ...
                <div className="space-y-4 text-center text-lg">
                    ...
                    <ol className="text-left list-decimal list-inside space-y-2 bg-slate-700 p-4 rounded-md">
                        <li>CBE Birr App ወይም *847# ይደውሉ</li>
                        <li>ወደ እኛ አካውንት ያስተላልፉ</li>
                        <li>Transaction Checker ገብተው ያስገቡትን ገንዘብ "Bingo" በማስገባት ገንዘቦን ይቀበሉ</li>
                    </ol>
                    ...
                    <div>
                        ...
                        <input
                            type="text"
                            id="transaction-id"
                            placeholder="Cbebirr ከላኩልን በኋላ የሚደርሶት Receipt ላይ ያለ ቁጥር, CAA23K319ZY"
...
export default CBEBirrDepositModal;
